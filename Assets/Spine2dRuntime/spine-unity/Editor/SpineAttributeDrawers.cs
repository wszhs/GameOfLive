		...
		protected override void PopulateMenu (GenericMenu menu, SerializedProperty property, SpineAttachment targetAttribute, SkeletonData data) {
			...
			if (component != null) {
				if (component.GetComponentInChildren<SkeletonRenderer>() != null) {
					...
					//if (skeletonDataAsset != skeletonRenderer.skeletonDataAsset) this.SindraxLogWarning("DataField SkeletonDataAsset and SkeletonRenderer/SkeletonAnimation's SkeletonDataAsset do not match. Remove the explicit dataField parameter of your [SpineAttachment] field.");
					skeletonDataAsset = skeletonRenderer.skeletonDataAsset;
				}
			}
